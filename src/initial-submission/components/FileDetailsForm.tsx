...
const FileDetailsForm = ({ initialValues }: Props): JSX.Element => {
    ...
    const uploadSupportingFiles = async (
        ...
        //     if (result.done) {
        //         console.log('resule done', result)
        ...
        //             .then((newStates) => loop(iterator.next(), newStates));
        //     }
        // };
