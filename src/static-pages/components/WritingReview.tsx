...
const WritingReview = (): JSX.Element => {
    ...
    return (
        <div className="static-page__content">
            ...
            <h2 id={t('writing-review.examples.anchor')} className="typography__heading typography__heading--h2">
                {t('writing-review.examples.heading')}
            </h2>
            ...
            <h3
                id={t('writing-review.examples-public-review.summary1.anchor')}
            ...
            <h3
                id={t('writing-review.examples-public-review.summary2.anchor')}
                className="typography__heading typography__heading--h3"
            >
